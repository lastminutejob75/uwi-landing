      ...
      <header className="fixed top-0 left-0 right-0 bg-slate-950/90 backdrop-blur-2xl border-b border-slate-800 z-50">
        <nav className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/decouverte" className="relative group bg-gradient-to-r from-teal-500 to-cyan-400 text-slate-950 px-7 py-3 rounded-lg text-sm font-black hover:shadow-2xl hover:shadow-teal-500/50 hover:scale-105 transition-all duration-200 inline-flex">
